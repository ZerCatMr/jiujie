...
public class RedisServiceImpl implements RedisService {
     ...
     */
    @Override
    public boolean cacheValues(String k, String v, long time) {
        try {
    ...
    @Override
    public boolean cacheValues(String key, String value) {
        return cacheValues(key, value, -1);
    }
     ...
     */
    @Override
    public boolean containsValueKeys(String key) {
