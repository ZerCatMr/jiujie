layui.define(function(exports){
    ...
    layui.use(['laydate','table','element','hdk','form','tool','appconfig'], function(){
        ...
        function loadRightDiv() {
            ...
            $("#examwork_assignexamsetmeal_edit #edit_right_setmeal").append(rightDiv);
            //加载拖拽事件
            var divId = document.getElementById('edit_right_setmeal');
            new Sortable(divId, {
                group: {
                    name:'examsetmeal'
                    //,pull: 'clone'
        ...
        function loadLeftDiv() {
            ...
            $("#edit_left_center_setmeal").append(leftDiv);
            let divId = document.getElementById('edit_left_center_setmeal');
            new Sortable(divId, {
                group: {
                    name:'examsetmeal'
                    //,pull: 'clone'
        ...
        $(document).on("click", ".bellows__header", function () {
            var state = $(this).parent().find(".bellows__content-wrapper").css("display");
            if(state==='block'){
        ...
        //点击title区域的编辑
        $('#examwork_assignexamsetmeal_edit [name="title_icon"]').click(function () {
            //获取title中的文本框
            let title = $(this).parent().find('[name="title_size"]').html();
            $('#examwork_assignexamsetmeal_edit [name="title_input"] input').attr("value", title);
            $('#examwork_assignexamsetmeal_edit [name="title_center"]').css("display", "none");
            $('#examwork_assignexamsetmeal_edit [name="title_input"]').css("display", "block");
            $('#examwork_assignexamsetmeal_edit [name="title_button"]').css("display", "block");
        });
        //点击title区域的取消
        $('#examwork_assignexamsetmeal_edit #edit_title_cancel').click(function () {
            //获取title中的文本框
            let title = $(this).parent().find('[name="title_size"]').html();
            $('#examwork_assignexamsetmeal_edit [name="title_center"]').css("display", "block");
            $('#examwork_assignexamsetmeal_edit [name="title_input"]').css("display", "none");
            $('#examwork_assignexamsetmeal_edit [name="title_button"]').css("display", "none");
        });
        //点击title区域的确认
        $('#examwork_assignexamsetmeal_edit #edit_title_submit').click(function () {
            //获取title中的文本框
            let title = $(this).parent().find('[name="title_size"]').html();
            //去后台保存最新名称...
            //去前端切换UI显示
        ...
        function updateLeftDiv(event, divId) {
            ...
            console.log("请求到后台改变排序")
        }
        //左侧体检小项排序
        $("#examwork_assignexamsetmeal_edit .left_center .escalate_sort").click(function () {
        ...
        //删除左侧体检小项
        $("#examwork_assignexamsetmeal_edit .left_center .dell_sort").click(function () {
           var smallId = $(this).parent().find(".small_center").attr("smallid");
           var smallName = $(this).parent().find(".small_center").html();
           var bigId = $(this).parent().parent().parent().find(".big_name").attr("bigid");
           var bigName = $(this).parent().parent().parent().find(".big_name").html();
            $(this).parent().remove();
           //发送ajax到后台改变当前排序
            console.log("移除小项"+smallId);
        });
        //删除左侧体检套餐
        $("#examwork_assignexamsetmeal_edit .left_center .big_del i").click(function () {
        ...
        //右侧添加体检小项
        $("#examwork_assignexamsetmeal_edit .bellows_content .bllows_small").click(function () {
           //获得当前的小项编号,小项名称,大项编号,大项名称
    ...
    exports('examwork/assign_examsetmeal_edit', {})
});
